...
char const *string_desc_arr[] = {
    ...
    "MSX Association",                  // 1: Manufacturer
    "MSXPLAYer Game Cartridge Adapter", // 2: Product
    NULL,                               // 3: Serials (null so it uses unique ID if available)
    "MSXCR CDC",                         // 4: CDC Interface 0
    "MSXCR Reset"                       // 5: Reset Interface
};
